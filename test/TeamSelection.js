...
describe('TeamSelection', function(){
  ...
  describe('selectTeamRecursive', function(){
    ...
    it.only('should allow for small team', function(){

       var team = new FootballTeam();
       var players =
       [  new FootballPlayer({ffpg: 1, position: 'RB', salary: 1}),
          new FootballPlayer({ffpg: 2, position: 'RB', salary: 2}),
          new FootballPlayer({ffpg: 1, position: 'RB', salary: 1}),
          new FootballPlayer({ffpg: 1, position: 'WR', salary: 1}),
          new FootballPlayer({ffpg: 2, position: 'WR', salary: 2}),
       ]
        team._validTeam = {
          'RB': 1,
          'WR': 1,
